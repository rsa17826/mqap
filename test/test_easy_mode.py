# from .bases import MathQuestTestBase

# # When writing a test, you'll first need to subclass unittest.TestCase.
# # In our case, we'll subclass the MathQuestTestBase we defined in bases.py.
# # class TestEasyModeLogic(MathQuestTestBase):
...
# #         # All other options in MathQuest are cosmetic, so we don't need to list them.
# #     }
...
# #                     "Final Boss Defeated", # Reminder: MathQuest's victory condition uses this event location
# #                 ],
# #                 [["Sword"]],
# #             )
...
#   def test_easy_mode_access(self) -> None:
#     with self.subTest("Verified Room Grid Access Requirements"):
#       # Verify reachability rules for 20_20
#       self.assertTrue(
#         self.world.get_region("20_20").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 19_20
#       self.assertTrue(
#         self.world.get_region("19_20").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 18_20
#       self.assertTrue(
#         self.world.get_region("18_20").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 18_19
#       self.assertTrue(
#         self.world.get_region("18_19").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 18_21
#       self.assertTrue(
#         self.world.get_region("18_21").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 19_21
#       self.assertTrue(
#         self.world.get_region("19_21").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 21_20
#       self.assertTrue(
#         self.world.get_region("21_20").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 21_21
#       self.assertTrue(
#         self.world.get_region("21_21").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 21_22
#       self.assertFalse(
#         self.world.get_region("21_22").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 21_23
#       self.assertFalse(
#         self.world.get_region("21_23").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 20_23
#       self.assertFalse(
#         self.world.get_region("20_23").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 20_22
#       self.assertFalse(
#         self.world.get_region("20_22").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 19_22
#       self.assertFalse(
#         self.world.get_region("19_22").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 20_21
#       self.assertFalse(
#         self.world.get_region("20_21").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 19_23
#       self.assertFalse(
#         self.world.get_region("19_23").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 18_23
#       self.assertFalse(
#         self.world.get_region("18_23").can_reach(self.multiworld.state)
#       )

#       # Verify reachability rules for 18_22
#       self.assertTrue(
#         self.world.get_region("18_22").can_reach(self.multiworld.state)
#       )
