...
class MathQuestWebWorld(WebWorld):
  ...
  setup_en: Tutorial = Tutorial(
    ...
    "A guide to setting up MathQuest for MultiWorld.",
    "English",
    "setup_en.md",
    "setup/en",
    ["NewSoupVi"],
  ...
  tutorials: list[Tutorial] = [setup_en, setup_de]

  # If we have option groups and/or option presets, we need to specify these here as well.
  option_groups: ClassVar[list[OptionGroup]] = option_groups
  options_presets: dict[str, dict[str, bool]] = option_presets
